...
class DateItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: _getContainerColorByState(dateItemState), border: Border.all(color: Theme_Information.Primary_Color), borderRadius: BorderRadius.circular(10.0),),
