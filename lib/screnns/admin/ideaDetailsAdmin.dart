...
class IdeaDetailsAdminPage extends StatefulWidget {
  const IdeaDetailsAdminPage({super.key , required this.item});
  final Idea item ;
  @override
  State<IdeaDetailsAdminPage> createState() => _IdeaDetailsAdminPageState();
}

class _IdeaDetailsAdminPageState extends State<IdeaDetailsAdminPage> {
            ...
            TextButton(
              ...
              onPressed: () async {
                if(widget.item.idea_id != null && widget.item.idea_id != ""){
                  ...
                  print("ddd__ ${widget.item.idea_id}");
                  await Provider.of<DataProvider>(context , listen: false).deleteIdeaFromAdmin(widget.item.idea_id??"");
